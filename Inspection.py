...
class Inspection:
    ...
    def print(self):
        print(self.nom, self.adresse, self.ville, self.date_visite,
              self.nom_plaignant, self.description)

    def jsonify(self):
        return {"nom": self.nom, "adresse": self.adresse, "ville": self.ville,
                "date_visite": self.date_visite,
                "nom_plaignant": self.nom_plaignant,
